...
const TableContainer = ({
    ...
    const onChangeInSelect = (event: any) => {
        ...
        handlePerPageChanged(Number(event.target.value))
    };
    const customPagination = () => {
        return (
            <DataTablePagination forcePage={currentPage} pageCount={pages} handlePagination={handlePagination}
    ...
    return (
        <Fragment>
            ...
            {
                !NoPagination ? <Row className="align-items-center mt-2 py-2 px-2 gy-2 text-center text-sm-end">

                    <div className="text-end">{customPagination()} </div>
                </Row> : null
            }
        </Fragment>
    );
