                                ...
                                <Card>
                                    <Card.Body>
                                        <Nav variant="pills" className="flex-column gap-3">
                                            <Nav.Item as='li'>
                                                <Nav.Link as="a" eventKey="profile" className="fs-15" role="presentation"><i className="bi bi-person-circle align-middle me-1"></i> {props.t('account-info')}</Nav.Link>
                                            </Nav.Item>
                                            <Nav.Item as='li'>
                                                <Nav.Link as="a" eventKey="setting" className="fs-15" role="presentation"><i className="bi bi-gear align-middle me-1"></i> {props.t('settings')}</Nav.Link>
                                            </Nav.Item >
                                            <Nav.Item as='li'>
                                                <Nav.Link as="a" eventKey="change-password" className="fs-15" role="presentation"><i className="bi bi-key-fill align-middle me-1"></i> {props.t('change-password')}</Nav.Link>
                                            </Nav.Item >
                                        </Nav>
                                    </Card.Body>
                                </Card>
